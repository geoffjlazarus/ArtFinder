...
--
-- Name: users; Type: TABLE; Schema: public; Owner: geofflazarus
--
...
ALTER TABLE public.users OWNER TO geofflazarus;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: geofflazarus
--
...
ALTER TABLE public.users_id_seq OWNER TO geofflazarus;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: geofflazarus
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: geofflazarus
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: geofflazarus
--

COPY public.users (id, email, password_digest) FROM stdin;
2	dt@ga.co	$2b$10$1QwDwsnU8GIgizU3lRIsRukw/Aosi4v4/pqVM4zWNMcXrBXm3f8Tq
\.
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: geofflazarus
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: geofflazarus
--
